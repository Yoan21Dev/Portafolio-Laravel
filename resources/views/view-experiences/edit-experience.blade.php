                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" required value="{{ old('title', $experience->title) }}">
                            </div>
                            {{-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                ease-in-out
                                m-0
                                focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" required value="{{ old('description', $experience->description) }}" >
                            </div>
