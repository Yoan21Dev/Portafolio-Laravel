            ...
            <div class="card bg-white border-2 rounded">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form action="{{ route('curso.update',$item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            ease-in-out
                            m-0
                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" required value="{{ old('title', $item->title) }}">
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            ease-in-out
                            m-0
                            focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" required value="{{ old('description', $item->description) }}" >
                        </div>
